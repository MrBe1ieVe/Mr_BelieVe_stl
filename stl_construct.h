...
#ifndef MR_BELIEVE_STL_STL_CONSTRUCT_H
#define MR_BELIEVE_STL_STL_CONSTRUCT_H
...
__STL_BEGIN_NAMESPACE
    ...
    // does not allocate memory -- calls: operator new (_T1(__value)),__p)
    // but constructs an object at __p
    template<class _T1>
...
__STL_END_NAMESPACE
#endif //MR_BELIEVE_STL_STL_CONSTRUCT_H
